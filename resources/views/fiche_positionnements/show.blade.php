      ...
      <div class="row no-print">
          ...
          <div class="col-12">
            <form action="{{ route('statistique_show') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="number" value="{{ $fiche_positionnement->id}}" hidden name="fiche_positionnement_id"/>
                <button type="submit" class="btn btn-primary my-2"><i class="fas fa-chart-line"></i> Statistique </button>
           </form>
          </div>
          <div class="col-12">
