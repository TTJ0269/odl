                        ...
                        <label for="text" class="col-sm-4 col-form-label">Téléphone</label>
                            <div class="col-sm-10">
                                <div class="input-group mb-3">
                                   ...
                                   <input type="text" class="form-control @error('teluser') is-invalid @enderror" name="teluser" placeholder="Rentrez le tel de l'apprenant(e)..." value="{{ old('teluser') ?? $apprenant->teluser }}" autofocus  required/>
                                </div>
                                @error('teluser')
                                    <div class="invalid-feedback">
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-append">
                                          <span class="input-group-text"><i class="nav-icon fas fa-at"></i></span>
                                           ...
                                           <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="Rentrez email de l'apprenant(e)..." value="{{ old('email') ?? $apprenant->email }}" autofocus  required/>
                                    </div>
                                    @error('email')
                                        <div class="invalid-feedback">
                                            {{ $errors->first('email')}}
