...
@section('content')
 ...
 <div class="content-header">
     <div class="container-fluid">
       <div class="row mb-2">
         <div class="col-sm-6">
           <h1 class="m-0">Etat - IFAD</h1>
         </div><!-- /.col -->
         <div class="col-sm-6">
           <ol class="breadcrumb float-sm-right">
           <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Accueil</a></li>
             <li class="breadcrumb-item active">Etat - IFAD</li>
           </ol>
         </div><!-- /.col -->
       </div><!-- /.row -->
     </div><!-- /.container-fluid -->
               ...
               <div class="col-sm-12">
                   <div class="card-body">
                               ...
                               <thead>
                                   ...
                                   <tr>
                                   <th scope="row"> {{++$key}} </th>
                                   <td> <a href="{{ route('index_nombrepositionnement', ['ifad' => $ifad->id]) }}" style="color:rgb(55, 144, 246);"> {{$ifad->libelleifad}} </a></td>
                                   </tr>
                                   @endforeach
                                   </tbody>
                               </table>
