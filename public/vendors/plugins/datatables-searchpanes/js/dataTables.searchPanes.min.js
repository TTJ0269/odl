...
*/
(function(){var g,s,t,n=function(a,b,d,c,f,h){var e=this;void 0===h&&(h=null);if(!s||!s.versionCheck||!s.versionCheck("1.10.0"))throw Error("SearchPane requires DataTables 1.10 or newer");if(!s.select)throw Error("SearchPane requires Select");a=new s.Api(a);this.metiers=g.extend(!0,{},n.metiers);this.c=g.extend(!0,{},n.defaults,b);this.customPaneSettings=h;this.s={cascadeRegen:!1,clearing:!1,colOpts:[],deselect:!1,displayed:!1,dt:a,dtPane:void 0,filteringActive:!1,index:d,indexes:[],lastCascade:!1,
lastSelect:!1,listSet:!1,name:void 0,redraw:!1,rowData:{arrayFilter:[],arrayOriginal:[],arrayTotals:[],bins:{},binsOriginal:{},binsTotal:{},filterMap:new Map,totalOptions:0},scrollTop:0,searchFunction:void 0,selectPresent:!1,serverSelect:[],serverSelecting:!1,showFiltered:!1,tableLength:null,updating:!1};b=a.columns().eq(0).toArray().length;this.colExists=this.s.index<b;this.c.layout=c;b=parseInt(c.split("-")[1],10);this.dom={buttonGroup:g("<div/>").addClass(this.metiers.buttonGroup),clear:g('<button type="button">&#215;</button>').addClass(this.metiers.dull).addClass(this.metiers.paneButton).addClass(this.metiers.clearButton),
container:g("<div/>").addClass(this.metiers.container).addClass(this.metiers.layout+(10>b?c:c.split("-")[0]+"-9")),countButton:g('<button type="button"></button>').addClass(this.metiers.paneButton).addClass(this.metiers.countButton),dtP:g("<table><thead><tr><th>"+(this.colExists?g(a.column(this.colExists?this.s.index:0).header()).text():this.customPaneSettings.header||"Custom Pane")+"</th><th/></tr></thead></table>"),lower:g("<div/>").addClass(this.metiers.subRow2).addClass(this.metiers.narrowButton),
nameButton:g('<button type="button"></button>').addClass(this.metiers.paneButton).addClass(this.metiers.nameButton),panesContainer:f,searchBox:g("<input/>").addClass(this.metiers.paneInputButton).addClass(this.metiers.search),searchButton:g('<button type = "button" class="'+this.metiers.searchIcon+'"></button>').addClass(this.metiers.paneButton),searchCont:g("<div/>").addClass(this.metiers.searchCont),searchLabelCont:g("<div/>").addClass(this.metiers.searchLabelCont),topRow:g("<div/>").addClass(this.metiers.topRow),
upper:g("<div/>").addClass(this.metiers.subRow1).addClass(this.metiers.narrowSearch)};this.s.displayed=!1;a=this.s.dt;this.selections=[];this.s.colOpts=this.colExists?this._getOptions():this._getBonusOptions();var l=this.s.colOpts,c=g('<button type="button">X</button>').addClass(this.metiers.paneButton);g(c).text(a.i18n("searchPanes.clearPane","X"));this.dom.container.addClass(l.className);this.dom.container.addClass(null!==this.customPaneSettings&&void 0!==this.customPaneSettings.className?this.customPaneSettings.className:
...
a instanceof g.fn.dataTable.Api&&(a=a.toArray())));return e._search(a,c)};g.fn.dataTable.ext.search.push(this.s.searchFunction);if(this.c.clear)g(c).on("click",function(){e.dom.container.find(e.metiers.search).each(function(){g(this).val("");g(this).trigger("input")});e.clearPane()});a.on("draw.dtsp",function(){e._adjustTopRow()});a.on("buttons-action",function(){e._adjustTopRow()});g(window).on("resize.dtsp",s.util.throttle(function(){e._adjustTopRow()}));a.on("column-reorder.dtsp",function(a,b,
...
this._searchExtras();(this.c.cascadePanes||this.c.viewTotal)&&this.updatePane()};n.prototype._setListeners=function(){var a=this,b=this.s.rowData,d;this.s.dtPane.on("select.dtsp",function(){clearTimeout(d);a.s.dt.page.info().serverSide&&!a.s.updating?a.s.serverSelecting||(a.s.serverSelect=a.s.dtPane.rows({selected:!0}).data().toArray(),a.s.scrollTop=g(a.s.dtPane.table().node()).parent()[0].scrollTop,a.s.selectPresent=!0,a.s.dt.draw(!1)):(g(a.dom.clear).removeClass(a.metiers.dull),a.s.selectPresent=
!0,a.s.updating||a._makeSelection(),a.s.selectPresent=!1)});this.s.dtPane.on("deselect.dtsp",function(){d=setTimeout(function(){a.s.dt.page.info().serverSide&&!a.s.updating?a.s.serverSelecting||(a.s.serverSelect=a.s.dtPane.rows({selected:!0}).data().toArray(),a.s.deselect=!0,a.s.dt.draw(!1)):(a.s.deselect=!0,0===a.s.dtPane.rows({selected:!0}).data().toArray().length&&g(a.dom.clear).addClass(a.metiers.dull),a._makeSelection(),a.s.deselect=!1,a.s.dt.state.save())},50)});this.s.dt.on("stateSaveParams.dtsp",
...
this.dom.container.find("."+this.metiers.subRowsContainer),b=this.dom.container.find(".dtsp-subRow1"),d=this.dom.container.find(".dtsp-subRow2"),c=this.dom.container.find("."+this.metiers.topRow);(252>g(a[0]).width()||252>g(c[0]).width())&&0!==g(a[0]).width()?(g(a[0]).addClass(this.metiers.narrow),g(b[0]).addClass(this.metiers.narrowSub).removeClass(this.metiers.narrowSearch),g(d[0]).addClass(this.metiers.narrowSub).removeClass(this.metiers.narrowButton)):(g(a[0]).removeClass(this.metiers.narrow),
g(b[0]).removeClass(this.metiers.narrowSub).addClass(this.metiers.narrowSearch),g(d[0]).removeClass(this.metiers.narrowSub).addClass(this.metiers.narrowButton))};n.prototype._buildPane=function(a,b,d,c,f){var h=this;void 0===a&&(a=[]);void 0===b&&(b=!1);void 0===d&&(d=null);void 0===c&&(c=null);void 0===f&&(f=null);this.selections=[];var e=this.s.dt,l=e.column(this.colExists?this.s.index:0),p=this.s.colOpts,j=this.s.rowData,i=e.i18n("searchPanes.count","{total}"),n=e.i18n("searchPanes.countFiltered",
"{shown} ({total})"),k=e.state.loaded();this.s.listSet&&(k=e.state());if(this.colExists){var o=-1;if(k&&k.searchPanes&&k.searchPanes.panes)for(var m=0;m<k.searchPanes.panes.length;m++)if(k.searchPanes.panes[m].id===this.s.index){o=m;break}if((!1===p.show||void 0!==p.show&&!0!==p.show)&&-1===o)return this.dom.container.addClass(this.metiers.hidden),this.s.displayed=!1;if(!0===p.show||-1!==o)this.s.displayed=!0;if(!this.s.dt.page.info().serverSide&&(null===d||null===d.searchPanes||null===d.searchPanes.options)){if(0===
j.arrayFilter.length){this._populatePane(b);this.s.rowData.totalOptions=0;this._detailsPane();if(k&&k.searchPanes&&k.searchPanes.panes&&-1===o){this.dom.container.addClass(this.metiers.hidden);this.s.displayed=!1;return}j.arrayOriginal=j.arrayTotals;j.binsOriginal=j.binsTotal}m=Object.keys(j.binsOriginal).length;b=this._uniqueRatio(m,e.rows()[0].length);if(!1===this.s.displayed&&((void 0===p.show&&null===p.threshold?b>this.c.threshold:b>p.threshold)||!0!==p.show&&1>=m)){this.dom.container.addClass(this.metiers.hidden);
this.s.displayed=!1;return}this.c.viewTotal&&0===j.arrayTotals.length?(this.s.rowData.totalOptions=0,this._detailsPane()):j.binsTotal=j.bins;this.dom.container.addClass(this.metiers.show);this.s.displayed=!0}else if(null!==d&&null!==d.searchPanes&&null!==d.searchPanes.options){if(void 0!==d.tableLength)this.s.tableLength=d.tableLength,this.s.rowData.totalOptions=this.s.tableLength;else if(null===this.s.tableLength||e.rows()[0].length>this.s.tableLength)this.s.tableLength=e.rows()[0].length,this.s.rowData.totalOptions=
...
c.replace(/{total}/,e.total);for(;c.indexOf("{shown}")!==-1;)c=c.replace(/{shown}/,e.shown);b='<span class="'+h.metiers.pill+'">'+c+"</span>";if(h.c.hideCount||p.hideCount)b="";return'<div class="'+h.metiers.nameCont+'"><span title="'+(typeof a==="string"&&a.match(/<[^>]*>/)!==null?a.replace(/<[^>]*>/g,""):a)+'" class="'+h.metiers.name+'">'+a+"</span>"+b+"</div>"},targets:0,type:void 0!==e.settings()[0].aoColumns[this.s.index]?e.settings()[0].aoColumns[this.s.index]._sManualType:null},{className:"dtsp-countColumn "+
this.metiers.badgePill,data:"shown",orderData:[1,2],targets:1,visible:!1},{data:"total",targets:2,visible:!1}],deferRender:!0,dom:"t",info:!1,language:this.s.dt.settings()[0].oLanguage,paging:f?!0:!1,scrollX:!1,scrollY:"200px",scroller:f?!0:!1,select:!0,stateSave:e.settings()[0].oFeatures.bStateSave?!0:!1},this.c.dtOpts,void 0!==p?p.dtOpts:{},void 0!==this.s.colOpts.options||!this.colExists?{createdRow:function(a,b){g(a).addClass(b.className)}}:void 0,null!==this.customPaneSettings&&void 0!==this.customPaneSettings.dtOpts?
this.customPaneSettings.dtOpts:{}));g(this.dom.dtP).addClass(this.metiers.table);g(this.dom.searchBox).attr("placeholder",void 0!==p.header?p.header:this.colExists?e.settings()[0].aoColumns[this.s.index].sTitle:this.customPaneSettings.header||"Custom Pane");g.fn.dataTable.select.init(this.s.dtPane);g.fn.dataTable.ext.errMode=m;if(this.colExists){var l=(l=l.search())?l.substr(1,l.length-2).split("|"):[],q=0;j.arrayFilter.forEach(function(a){""===a.filter&&q++});m=0;for(f=j.arrayFilter.length;m<f;m++){for(var l=
...
function(){var a=this.s.updating;this.s.updating=!0;var b=this.s.dtPane.rows({selected:!0}).data().pluck("filter").toArray(),d=b.indexOf(!1!==this.s.colOpts.emptyMessage?this.s.colOpts.emptyMessage:this.c.emptyMessage),c=g(this.s.dtPane.table().container());-1<d&&(b[d]="");0<b.length?c.addClass(this.metiers.selected):0===b.length&&c.removeClass(this.metiers.selected);this.s.updating=a};n.prototype._uniqueRatio=function(a,b){return 0<b&&(0<this.s.rowData.totalOptions&&!this.s.dt.page.info().serverSide||
...
show:void 0,sort:"sort",threshold:0.6,type:"type"},preSelect:[],threshold:0.6,viewTotal:!1};t=n;var i,r,u,k=function(a,b,d){var c=this;void 0===d&&(d=!1);this.regenerating=!1;if(!r||!r.versionCheck||!r.versionCheck("1.10.0"))throw Error("SearchPane requires DataTables 1.10 or newer");if(!r.select)throw Error("SearchPane requires Select");var f=new r.Api(a);this.metiers=i.extend(!0,{},k.metiers);this.c=i.extend(!0,{},k.defaults,b);this.dom={clearAll:i('<button type="button">Clear All</button>').addClass(this.metiers.clearAll),
container:i("<div/>").addClass(this.metiers.panes).text(f.i18n("searchPanes.loadMessage","Loading Search Panes...")),emptyMessage:i("<div/>").addClass(this.metiers.emptyMessage),options:i("<div/>").addClass(this.metiers.container),panes:i("<div/>").addClass(this.metiers.container),title:i("<div/>").addClass(this.metiers.title),titleRow:i("<div/>").addClass(this.metiers.titleRow),wrapper:i("<div/>")};this.s={colOpts:[],dt:f,filterCount:0,filterPane:-1,page:0,panes:[],selectionList:[],serverData:{},
...
!0;f.s.filteringActive=!0;if(-1!==c&&null!==c&&c===f.s.index||!1===d)b=!1,f.s.filteringActive=!1;f.updatePane(!b?b:d)}}}d||(this.s.selectionList=[])}};k.prototype._attach=function(){var a=this;i(this.dom.container).removeClass(this.metiers.hide);i(this.dom.titleRow).removeClass(this.metiers.hide);i(this.dom.titleRow).remove();i(this.dom.title).appendTo(this.dom.titleRow);this.c.clear&&(i(this.dom.clearAll).appendTo(this.dom.titleRow),i(this.dom.clearAll).on("click.dtsps",function(){a.clearSelections()}));
i(this.dom.titleRow).appendTo(this.dom.container);for(var b=0,d=this.s.panes;b<d.length;b++)i(d[b].dom.container).appendTo(this.dom.panes);i(this.dom.panes).appendTo(this.dom.container);0===i("div."+this.metiers.container).length&&i(this.dom.container).prependTo(this.s.dt);return this.dom.container};k.prototype._attachExtras=function(){i(this.dom.container).removeClass(this.metiers.hide);i(this.dom.titleRow).removeClass(this.metiers.hide);i(this.dom.titleRow).remove();i(this.dom.title).appendTo(this.dom.titleRow);
this.c.clear&&i(this.dom.clearAll).appendTo(this.dom.titleRow);i(this.dom.titleRow).appendTo(this.dom.container);return this.dom.container};k.prototype._attachMessage=function(){var a;try{a=this.s.dt.i18n("searchPanes.emptyPanes","No SearchPanes")}catch(b){a=null}if(null===a)i(this.dom.container).addClass(this.metiers.hide),i(this.dom.titleRow).removeClass(this.metiers.hide);else return i(this.dom.container).removeClass(this.metiers.hide),i(this.dom.titleRow).addClass(this.metiers.hide),i(this.dom.emptyMessage).text(a),
